...
export const letsEncryptTest = new k8s.apiextensions.CustomResource("letsencrypt-test", {
...
export const letsEncrypt = new k8s.apiextensions.CustomResource("letsencrypt", {
    apiVersion: "cert-manager.io/v1",
    kind: "ClusterIssuer",
